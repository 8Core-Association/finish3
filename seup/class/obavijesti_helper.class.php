...
class ObavijestHelper
{
    ...
    public function getAktivneObavijesti()
    {
        $sql = "SELECT rowid, naslov, sadrzaj, tip, vanjski_link, datum_kreiranja
                FROM " . MAIN_DB_PREFIX . "seup_obavijesti
                WHERE aktivan = 1
    ...
    {
        $sql = "SELECT rowid FROM " . MAIN_DB_PREFIX . "seup_obavijesti_procitane
    ...
    public function oznaciKaoProcitanu($obavijest_id)
    {
        ...
        $sql = "INSERT INTO " . MAIN_DB_PREFIX . "seup_obavijesti_procitane
    ...
    {
        $sql = "INSERT INTO " . MAIN_DB_PREFIX . "seup_obavijesti
        ...
        return $resql ? $this->db->last_insert_id(MAIN_DB_PREFIX . "seup_obavijesti") : false;
    }

    public function updateObavijest($rowid, $data)
    {
        $sql = "UPDATE " . MAIN_DB_PREFIX . "seup_obavijesti SET
    ...
    {
        $sql = "DELETE FROM " . MAIN_DB_PREFIX . "seup_obavijesti
                WHERE rowid = " . ((int) $rowid);
